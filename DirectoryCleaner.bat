...
REM ----------------------------------------------------------------------
REM DirectoryCleaner v1.0.1 (https://github.com/earthperson/DirectoryCleaner)
REM
...
TITLE DirectoryCleaner v1.0.1. Copyright (c) 2009 Dmitry Ponomarev (e-mail: ponomarev.dev@gmail.com)
